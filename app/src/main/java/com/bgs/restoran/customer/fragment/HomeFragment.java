...
import com.programming.restoran.customer.activity.RegisterActivity;
import com.programming.restoran.customer.activity.TesByte;
import com.programming.restoran.customer.adapter.RecyclerViewHidangan;
import com.programming.restoran.customer.activity.MenuPerKategoriActivity;
import com.programming.restoran.customer.model.Hidangan;
import com.programming.restoran.customer.storage.DatabaseHelper;
...
//        Toast.makeText(getActivity(), "jumlah hidangan "+jmlHidangan, Toast.LENGTH_SHORT).show();
        ...
        if(jmlHidangan==0){
            // Kalo di sqlite gak ada data, berarti dia baru nginstal, jadi pindahin data database ke sqlite
